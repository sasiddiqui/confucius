...
#%%
deleted_response = retrieve_and_rank.delete_collection(solr_cluster_id, 'reddit_data', 'solr_config')
print(json.dumps(deleted_response, indent=2))
#%%
...
status = retrieve_and_rank.get_ranker_status('1eec74x28-rank-5332')
print(json.dumps(status, indent=2))
#%%
#Delete a ranker
...
#%%
solr_cluster_id = 'scc3ecccbb_2901_4275_b4d7_11342899dca1'
ranker_id = '1eec7cx29-rank-5319'
#data = {'answers': + 10}
url = '/v1/solr_clusters/'+solr_cluster_id+'/solr/'+'reddit_data'+'/fcselect?q='+'What the notes of music ?'+'&ranker_id='+ranker_id
results = retrieve_and_rank.request(method='GET',url=url,accept_json=False)
#%%
solr_cluster_id = 'scc3ecccbb_2901_4275_b4d7_11342899dca1'
ranker_id = '1eec74x28-rank-5332'
results = retrieve_and_rank.rank(solr_cluster_id, ranker_id, 'reddit_data', 'What is the truth about jfk ? ')